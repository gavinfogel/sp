...
<ul class="flex flex-col space-y-8 text-xxl mt-24">
	<li>
		...
		https://www.gordondoherty.co.uk/writeblog/death-from-the-waves-the-sea-people [Accessed 1 May
		2024].
	</li>
	<li>
		www.youtube.com. (n.d.). Who were the Sea Peoples? | The Bronze Age Collapse. [online] Available
...
<div class="text-xl mt-24">
	...
	<ul class="flex flex-col space-y-2 mt-12">
		...
		<li>Sea Peoples Philistine maritime DNA spiral abstract oil painting 4k science</li>
	</ul>
</div>
